...
def cratepdf(companynamepdf, companyaddresspdf, amountpdf, staxpdf, emailpdf, timestamppdf, canvas2, datepdf, finalstaxpdf, productpdf, quantitypdf):
    canvas = canvas2.Canvas("E:\invoice\core\Invoice{}.pdf".format(str(companynamepdf)), pagesize=letter)
...
def Crate():
    ...
    Invoicename = "E:\invoice\core\Invoice{}.pdf".format(str(companyname))
    finalstax = int(amount)*int(quantity) + (int(amount) * ((int(stax))/100))
    print(finalstax)
